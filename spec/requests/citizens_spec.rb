...
RSpec.describe "/citizens", type: :request do
  ...
  describe "GET /show" do
    it "renders a successful response" do
      address = Citizen.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Address" do
        expect {
          post citizens_url, params: { address: valid_attributes }
        }.to change(Address, :count).by(1)
      end

      it "redirects to the created address" do
        post citizens_url, params: { address: valid_attributes }
        expect(response).to redirect_to(address_url(Acitizen.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Address" do
        expect {
          post citizens_url, params: { address: invalid_attributes }
